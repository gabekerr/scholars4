...
},
{
  "id": "sec-limit-7",
  "level": "2",
  "url": "sec-limit.html#sec-limit-7",
  "type": "Example",
  "number": "1.1.2",
...
},
{
  "id": "sec-limit-8",
  "level": "2",
  "url": "sec-limit.html#sec-limit-8",
  "type": "Example",
  "number": "1.1.3",
...
},
{
  "id": "sec-limit-10",
  "level": "2",
  "url": "sec-limit.html#sec-limit-10",
  "type": "Example",
  "number": "1.1.4",
  "title": "Non-existent limit with well defined limits along straight lines.",
...
},
{
  "id": "sec-limit-13",
  "level": "2",
  "url": "sec-limit.html#sec-limit-13",
  "type": "Example",
  "number": "1.1.6",
  "title": "Non-existent limit with well defined limits along straight lines.",
...
},
{
  "id": "sec-limit-16",
  "level": "2",
  "url": "sec-limit.html#sec-limit-16",
  "type": "Example",
  "number": "1.1.7",
  "title": "Limit that appears to exist, but does not.",
  "body": " Limit that appears to exist, but does not   Consider the function which is continuous everywhere except at the origin where it is undefined. We again consider the limit of as one approaches . One could try to examine the limit of along any line through the origin (the case of can be evaluated separately). Here we have which, if converges to . The case of gives which converges to as well. It may than seem that the limit of as is zero. After all, we have approached the origin in every linear direction and found the same limit of . However, the limit in fact does not exist ! Indeed, if we approach the origin along the parabola, we see so that the limit is on this approach. This phenomena shows that, while taking different linear approaches may show that a limit does not exist, it cannot show that a limit does exist.   "
},
{
  "id": "exe-limit-1",
  "level": "2",
...
},
{
  ...
  "number": "1.2.12",
  "title": "",
  "body": "   linear approximation    Given a function on a neighborhood of a point and differentiable at , the linear approximation of at is the function    "
},
{
...
},
{
  ...
  "number": "1.2.5.1",
  "title": "",
  "body": " For the case of , , explain why is the same as the usual definition of the derivative.  "
},
{
  "id": "exe-derivative-2",
  "level": "2",
...
},
{
  ...
  "number": "1.3.2",
  "title": "",
  "body": "   Tangent space    Let be an open neighborhood of in an inner product space and some other inner product space. We say that a function  vanishes higher than first order at if    "
},
{
  "id": "lem-vanishing",
  "level": "2",
...
},
{
  ...
  "body": " Implicit Function Theorem   Let be an open set in , and the level set of all points with for some fixed . If is differentiable at and then the tangent space to at as a subspace of is   "
},
{
...
},
{
  ...
  "number": "1.3.4.6",
  "title": "",
  "body": " Find the tangent plane of the torus in which is given by the pair of constraints Here the coordinates of are .  "
},
{
  "id": "sec-gradient",
  "level": "1",
...
{
  "id": "subsec-metric-geometry-6",
  "level": "2",
  "url": "sec-gradient.html#subsec-metric-geometry-6",
  "type": "Example",
  "number": "1.4.2",
...
},
{
  ...
  "number": "1.4.7",
  "title": "",
  "body": "   Gradient    Let be a domain in with metric with varying inner product , and a differentiable scalar function. The gradient of at is the tangent vector for which The gradient of is the vector field with tangent vector at .   "
},
{
...
{
  "id": "subsec-steepest-ascent-13",
  "level": "2",
  "url": "sec-gradient.html#subsec-steepest-ascent-13",
  "type": "Proposition",
  "number": "1.4.12",
  "title": "",
...
{
  "id": "subsec-steepest-ascent-16",
  "level": "2",
  "url": "sec-gradient.html#subsec-steepest-ascent-16",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "1.4.3.1",
  "title": "",
  "body": "Let be the closed half-disc and consider the function given by  Find the matrix representing the inner product on induced by ?   Is a conformal map? Explain your response.   Does preserve distance?  "
},
{
  "id": "exe-gradient-2",
  "level": "2",
...
},
{
  ...
  "number": "1.4.3.6",
  "title": "",
  "body": " For each of the functions in the previous exercise, give the direction vector for which the function, starting at , is has steepest descent.  "
},
{
  "id": "exe-gradient-7",
  "level": "2",
  ...
  "number": "1.4.3.7",
  "title": "",
  "body": "Complete the following steps:  Write down an example of a non-zero quadratic form .   Solve your ordinary differential equation.  "
},
{
  "id": "exe-gradient-8",
  "level": "2",
...
},
{
  ...
  "number": "1.5.1",
  "title": "",
  "body": "   Critical point    Suppose is a domain with metric in and is scalar function. We call a \\textbf{critical point} of if either is not differentiable at or if The value is called a of .   "
},
{
  "id": "sec-critical-2-4",
  "level": "2",
...
},
{
  ...
  "number": "1.5.7",
  "title": "",
  "body": "   The Hessian    Suppose is a domain with metric in and is scalar function with continuous second partial derivatives. The Hessian of is the matrix valued function \\begin{align*} \\textnormal{Hess} (f) \\amp = \\left[ \\begin{matrix} \\frac{\\partial^2 f}{\\partial x_1^2} \\amp \\frac{\\partial^2 f}{\\partial x_1 \\partial x_2} \\amp \\cdots \\amp \\frac{\\partial^2 f}{\\partial x_1 \\partial x_m} \\\\ \\frac{\\partial^2 f}{\\partial x_2 \\partial x_1} \\amp \\frac{\\partial^2 f}{\\partial x_2^2} \\amp \\cdots \\amp \\frac{\\partial^2 f}{\\partial x_2 \\partial x_m} \\\\ \\vdots \\amp \\vdots \\amp \\amp \\vdots \\\\ \\frac{\\partial^2 f}{\\partial x_m \\partial x_1} \\amp \\frac{\\partial^2 f}{\\partial x_m \\partial x_2} \\amp \\cdots \\amp \\frac{\\partial^2 f}{\\partial x_m^2} \\end{matrix} \\right] \\end{align*} Write for the Hessian of evaluated at . We say a critical point of is non-degenerate if has non-zero determinant.   "
},
{
...
},
{
  ...
  "number": "3.1.1",
  "title": "",
  "body": "   -dimensional cube    A cube  , or -cube, in is a product of intervals Alternatively, it can be described by the set of points which satisfy the inequalities   "
},
{
...
},
{
  ...
  "number": "3.1.2",
  "title": "",
  "body": "   multiple integral    The multiple integral of a function on the cube is the limit if it exists. If the limit exists, we say that is integrable on .   "
},
{
  ...
  "number": "3.1.3",
  "title": "",
  "body": "   Integral of with respect to the -th variable    Let be defined on the -cube . The integral of with respect to the -th variable is the function on the -cube . We say that is integrable with respect to if the integral of with respect to the -th variable exists.   "
},
{
  "id": "ex-integral1",
  "level": "2",
...
},
{
  ...
  "number": "3.1.6",
  "title": "",
  "body": "   Iterated integral    An iterated integral of on is the value of for some ordered sequence of variables . We say that has \\textbf{all iterated integrals} the iterated integral exists for every ordered sequence of variables.   "
},
{
...
},
{
  ...
  "number": "3.1.5",
  "title": "",
  "body": " Let be a continuous function on the unit ball If we take to be the function on the cube which is on and off of , show that is integrable on .  "
},
{
...
},
{
  ...
  "number": "3.2.2",
  "title": "",
  "body": "  If is a compact domain in and is continuous on , then the multiple integral exists.   "
},
{
  "id": "def-volume",
  "level": "2",
