...
},
{
  ...
  "number": "1.7.2",
  "title": "",
  "body": "   Smooth parameterization    We say that a subspace of is smooth at if there is an open set of and a smooth parameterization with image equal to a ball in intersected with . We say that is smooth if it is closed and smooth at every point in .   "
},
{
...
},
{
  ...
  "number": "1.7.4",
  "title": "",
  "body": "   Critical point on subspace    Suppose is a subspace of contained in an open set and is a scalar function. We say that a point of is a if either:   is not smooth at ,   is smooth at and, given any parameterization of near with , is a critical point of the composition .     "
},
{
...
},
{
  ...
  "number": "2.2.4",
  "title": "",
  "body": "   Bounded by continuous graphs of     A compact domain in is bounded by continuous graphs of if there is an interval and continuous functions for which The domain is if there is an interval and continuous functions for which   "
},
{
...
},
{
  ...
  "body": " Fundamental Theorem of Line Integrals   Suppose is a piecewise smooth curve in oriented from to and is a conservative vector field defined on a neighborhood of with potential . Then    Now, we recall that and is an exact form. Also, dualizing twice does nothing, and so using the definition of vector line integral in along with Stokes' we obtain   "
},
{
  "id": "sec-ftli-14",
  "level": "2",
